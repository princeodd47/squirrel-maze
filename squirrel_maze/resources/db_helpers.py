...
class Database:
    ...
    def get_actor(
        self, actor_id: int, pc_type: str = "npc", affiliation: str = "friendly"
    ) -> Actor:
        db_actor = self.get_actor_by_id(actor_id)
        return Actor(
            name=db_actor["name"],
            stats={
                "level": db_actor["attributes"]["level"],
                "max_str": db_actor["attributes"]["str"],
                "max_dex": db_actor["attributes"]["dex"],
                "max_sta": db_actor["attributes"]["sta"],
                "max_hp": db_actor["attributes"]["hp"],
            },
            pc_type=pc_type,
